...
export default {
  ...
  methods: {
    ...
    // 重置修改的表单
    editDialogClosed () {
      this.$refs.editDialogVisible.resetFields()
    },
    // 点击按钮,修改参数信息
    editParams () {
    ...
    async removeParams (attrId) {
      const confirmResult = await this.$confirm('此操作将永久该参数, 是否继续?', '提示', {
          ...
          <el-table :data="manyTableData" border stripe>
            ...
            <el-table-column label="操作">
              <template slot-scope="scope">
                ...
                <el-button type="danger" size="mini" icon="el-icon-delete" @click="removeParams(scope.row.attr_id)">
                  删除
                </el-button>
              </template>
            </el-table-column>
